...
var lightDirection = new Vector4(5, 3, 0, 0);
...
function updateAndRender() {
    ...
    if(appInput.up){ 
        //console.log(appInput.up)
        lightDirection =  rMatrix.makeRotationX(-1.5).multiplyVector(lightDirection);
    }
       ...
       // console.log("left")
        lightDirection = rMatrix.makeRotationY(1.5).multiplyVector(lightDirection);
    }
