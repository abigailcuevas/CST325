...
function WebGLGeometryJSON(gl) {
	...
	this.create = function(jsonFileData, rawImage) {
        ...
        if (rawImage) {
            ...
            this.gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S,gl.REPEAT);//REPEAT); //todo 11
            this.gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T,gl.REPEAT);//REPEAT);//todo 11
	...
	this.render = function(camera, projectionMatrix, shaderProgram) {
        ...
        gl.uniform1f(uniforms.timeUniform, time.secondsElapsedSinceStart);//todo 11
