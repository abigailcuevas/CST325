...
function createShaders(loadedAssets) {
    ...
    textureShaderProgram.uniforms = {
        ...
        timeUniform: gl.getUniformLocation(textureShaderProgram, "uTempAlpha"),//todo #11
    };
}
...
function updateAndRender() {
    ...
    const newSpereGeometryList = sphereGeometryList.sort(function(a,b) {
    ...
    for (var i = 0; i < newSpereGeometryList.length; ++i) {
         newSpereGeometryList[i].render(camera, projectionMatrix, textureShaderProgram);
    }
